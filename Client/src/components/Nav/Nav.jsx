     ...
     <nav className={style.nav}>
         <div className={style.logo}><img src={logo} alt=''/></div>
            ...
            <div className={style.item}>
               <NavLink className={style.linkMenu} to='/home'>
                  <div className={style.itemsDiv} ><FontAwesomeIcon icon={faHouse}/>  Home</div>
               </NavLink> 
               <NavLink className={style.linkMenu} to='/favorites'>
                  <div className={style.itemsDiv} ><FontAwesomeIcon icon={faHeart} />  Favorites</div>
               </NavLink>
               <NavLink className={style.linkMenu} to='/about'>
                  <div className={style.itemsDiv} ><FontAwesomeIcon icon={faCircleUser} />  About Me</div>
               </NavLink>
               <div  onClick={logout} className={style.itemsDiv}><FontAwesomeIcon icon={faRightFromBracket} />  Log Out</div>
            </div>}
