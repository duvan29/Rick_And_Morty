     ...
     <nav className={style.nav}>
         <div className={style.logo}><img src={logo} alt=''/></div>
            ...
            <div className={style.item}>
               <NavLink className={style.linkMenu} >
                  <div className={style.itemsDiv} ><div className={style.ocltar}><FontAwesomeIcon icon={faHouse}/>  Home</div></div>
               </NavLink> 
               <NavLink className={style.linkMenu} >
                  <div className={style.itemsDiv} ><div className={style.ocltar}><FontAwesomeIcon icon={faHeart} />  Favorites</div></div>
               </NavLink>
               <NavLink className={style.linkMenu} >
                  <div className={style.itemsDiv} ><div className={style.ocltar}><FontAwesomeIcon icon={faCircleUser} />  About Me</div></div>
               </NavLink>
               <div  className={style.itemsDiv}><div className={style.ocltar}><FontAwesomeIcon icon={faRightFromBracket} />  Log Out</div></div>
            </div>}
